...
export function ChapterShareOptions({ chapterTitle, chapterUrl, bookTitle, authorName }: ChapterShareOptionsProps) {
  ...
  const shareOnWhatsApp = (title: string, url: string) => {
    const text = `Check out "${title}" from "${bookTitle}" by ${authorName}"`;
